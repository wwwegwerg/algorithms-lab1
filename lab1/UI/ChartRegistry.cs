...
public static class ChartRegistry
{
    ...
    public static Dictionary<string, Func<GenericChart>> All { get; } =
        new()
        {
            ["const"] = () =>
            {
                var cd = Experiments.BuildChartDataForConstant(5, 5, 20_000);
            ...
            ["naive pow"] = () =>
            {
                var cd = Experiments.BuildChartDataForNaivePow(50_000);
                var chart = Builder.Build2DLineChart(cd);
                return chart;
            },
            ...
            ["rec pow"] = () =>
            {
                var cd = Experiments.BuildChartDataForRecPow(50_000);
                var chart = Builder.Build2DLineChart(cd);
                return chart;
            },
            ...
            ["quick pow"] = () =>
            {
                var cd = Experiments.BuildChartDataForQuickPow(50_000);
                var chart = Builder.Build2DLineChart(cd);
                return chart;
            },
            ...
            ["classic quick pow"] = () =>
            {
                var cd = Experiments.BuildChartDataForClassicQuickPow(50_000);
                var chart = Builder.Build2DLineChart(cd);
                return chart;
            },
